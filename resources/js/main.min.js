 ...
 */
! function(t, e) {
    "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? module.exports = e() : t.Flipsnap = e()
}(this, function() {
    function t(e, n) {
    ...
    function r(t, e, n) {
        var r = d[e];
        r ? t[r] = n : void 0 !== t[e] ? (d[e] = e, t[e] = n) : a(m, function(r) {
            var o = i(r) + i(e);
            if (void 0 !== t[o]) return d[e] = o, t[o] = n, !0
        })
    }

    function o(t) {
        if (void 0 !== u.style[t]) return t;
        var e;
        return a(m, function(n) {
            var r = i(n) + i(t);
            if (void 0 !== u.style[r]) return e = "-" + n + "-" + t, !0
        }), e
    }
    ...
    function s(t, e, n, r) {
        var o = Math.abs(t - n),
            i = Math.abs(e - r),
            a = Math.sqrt(Math.pow(o, 2) + Math.pow(i, 2));
        return {
            x: o,
            y: i,
            z: a
    ...
    return v.addEventListener && (document.addEventListener("gesturestart", function() {
        l = !0
    }), document.addEventListener("gestureend", function() {
        l = !1
    })), t.prototype.init = function(t, e) {
        var n = this;
        if (n.element = t, "string" == typeof t && (n.element = document.querySelector(t)), !n.element) throw new Error("element not found");
        return v.mspointer && (n.element.style.msTouchAction = "pan-y"), e = e || {}, n.distance = e.distance, n.maxPoint = e.maxPoint, n.disableTouch = void 0 !== e.disableTouch && e.disableTouch, n.disable3d = void 0 !== e.disable3d && e.disable3d, n.transitionDuration = void 0 === e.transitionDuration ? "350ms" : e.transitionDuration + "ms", n.threshold = e.threshold || 0, n.currentPoint = 0, n.currentX = 0, n.animation = !1, n.timerId = null, n.use3d = v.transform3d, n.disable3d === !0 && (n.use3d = !1), v.cssAnimation ? n._setStyle({
            ...
            position: "relative",
            left: "0px"
        }), n.refresh(), p.forEach(function(t) {
            n.element.addEventListener(P.start[t], n, !1)
        }), n
        ...
        t._maxPoint = void 0 === t.maxPoint ? function() {
            for (var e, n = t.element.childNodes, r = -1, o = 0, i = n.length; o < i; o++) e = n[o], 1 === e.nodeType && r++;
            return r
        }() : t.maxPoint, void 0 === t.distance ? t._maxPoint < 0 ? t._distance = 0 : t._distance = t.element.scrollWidth / (t._maxPoint + 1) : t._distance = t.distance, t._maxX = -t._distance * t._maxPoint, t.moveToPoint()
        ...
        void 0 === t && (t = n.currentPoint), t < 0 ? n.currentPoint = 0 : t > n._maxPoint ? n.currentPoint = n._maxPoint : n.currentPoint = parseInt(t, 10), v.cssAnimation ? n._setStyle({
            transitionDuration: e
        }) : n.animation = !0, n._setX(-n.currentPoint * n._distance, e), r !== n.currentPoint && (n._triggerEvent("fsmoveend", !0, !1), n._triggerEvent("fspointmove", !0, !1))
    }, t.prototype._setX = function(t, e) {
        var n = this;
        n.currentX = t, v.cssAnimation ? n.element.style[d.transform] = n._getTranslate(t) : n.animation ? n._animate(t, e || n.transitionDuration) : n.element.style.left = t + "px"
    }, t.prototype._touchStart = function(t, n) {
        var r = this;
        if (!(r.disableTouch || r.scrolling || l)) {
            r.element.addEventListener(P.move[n], r, !1), document.addEventListener(P.end[n], r, !1);
            var o = t.target.tagName;
            "mouse" === n && "SELECT" !== o && "INPUT" !== o && "TEXTAREA" !== o && "BUTTON" !== o && t.preventDefault(), v.cssAnimation ? r._setStyle({
                transitionDuration: "0ms"
            }) : r.animation = !1, r.scrolling = !0, r.moveReady = !1, r.startPageX = e(t, "pageX"), r.startPageY = e(t, "pageY"), r.basePageX = r.startPageX, r.directionX = 0, r.startTime = t.timeStamp, r._triggerEvent("fstouchstart", !0, !1)
        }
        ...
        if (r.scrolling && !l) {
            var o, i, a = e(t, "pageX"),
                u = e(t, "pageY");
            if (r.moveReady) {
                t.preventDefault(), o = a - r.basePageX, i = r.currentX + o, (i >= 0 || i < r._maxX) && (i = Math.round(r.currentX + o / 3)), r.directionX = 0 === o ? r.directionX : o > 0 ? -1 : 1;
                var m = !r._triggerEvent("fstouchmove", !0, !0, {
                    delta: o,
                ...
                var d = s(r.startPageX, r.startPageY, a, u);
                d.z > f && (c(d) > h ? (t.preventDefault(), r.moveReady = !0, r.element.addEventListener("click", r, !0)) : r.scrolling = !1)
            }
            r.basePageX = a
        }
    }, t.prototype._touchEnd = function(t, e) {
        var n = this;
        if (n.element.removeEventListener(P.move[e], n, !1), document.removeEventListener(P.end[e], n, !1), n.scrolling) {
            var r = -n.currentX / n._distance;
            r = n.directionX > 0 ? Math.ceil(r) : n.directionX < 0 ? Math.floor(r) : Math.round(r), r < 0 ? r = 0 : r > n._maxPoint && (r = n._maxPoint), Math.abs(n.startPageX - n.basePageX) < n.threshold && (r = n.currentPoint), n._touchAfter({
        ...
        var e = this,
            n = e.element.style;
        for (var o in t) r(n, o, t[o])
    }, t.prototype._animate = function(t, e) {
        var n = this,
            r = n.element,
            o = +new Date,
            i = parseInt(r.style.left, 10),
            a = t,
            s = parseInt(e, 10),
            c = function(t, e) {
                return -(t /= e) * (t - 2)
        ...
        n.timerId && clearInterval(n.timerId), n.timerId = setInterval(function() {
            var t, e, u = new Date - o;
            u > s ? (clearInterval(n.timerId), n.timerId = null, e = a) : (t = c(u, s), e = t * (a - i) + i), r.style.left = e + "px"
        }, 10)
    }, t.prototype.destroy = function() {
        var t = this;
        p.forEach(function(e) {
            t.element.removeEventListener(P.start[e], t, !1)
        })
        ...
        if (i.initEvent(t, e, n), r)
            for (var a in r) r.hasOwnProperty(a) && (i[a] = r[a]);
        return o.element.dispatchEvent(i)
    }, t
});
/**
 * @license
...
(function() {
    ...
    function v(t, n, r, e) {
        ...
        return r(t, function(t, r, o) {
            return n(t, r, o) ? (u = e ? r : t, !1) : void 0
        }), u
    }
    ...
    function U(t, n) {
        return t = "number" == typeof t || jt.test(t) ? +t : -1, t > -1 && 0 == t % 1 && (null == n ? 9007199254740991 : n) > t
    }
    ...
    function T(S) {
        ...
        function Ft(t, n) {
            var r = t.__data__;
            return qr(n) ? (r = r.__data__, "__lodash_hash_undefined__" === ("string" == typeof n ? r.string : r.hash)[n]) : r.has(n)
        }
        ...
        function Tt(t, n) {
            var r = Kt(t, n);
            return !(0 > r) && (r == t.length - 1 ? t.pop() : Uu.call(t, r, 1), !0)
        }
        ...
        function Qt(t, n, r) {
            (r === q || we(t[n], r)) && ("number" != typeof n || r !== q || n in t) || (t[n] = r)
        }
            ...
            return function(e) {
                ...
                for (var u = r; u--;) {
                    var o = n[u],
                        i = t[o],
                        f = e[o];
                    if (f === q && !(o in Object(e)) || !i(f)) return !1
                }
                return !0
            }
        }
        ...
        function cn(t, n, r) {
            if ("function" != typeof t) throw new vu("Expected a function");
            return zu(function() {
                t.apply(q, r)
            }, n)
        }
        ...
        function an(t, n, r, e) {
            var u = -1,
                ...
                h = n.length;
            if (!l) return s;
            r && (n = a(n, O(r))), e ? (o = c, i = !1) : n.length >= 200 && (o = Ft, i = !1, n = new $t(n));
            t: for (; ++u < l;) {
                var p = t[u],
                    _ = r ? r(p) : p;
                if (i && _ === _) {
        ...
        function yn(t, n) {
            return xu.call(t, n) || "object" == typeof t && n in t && null === Fu(Object(t))
        }
        ...
        function wn(t, n, r, e, u) {
            if (t === n) n = !0;
                ...
                n = o || Fe(t) ? Er(t, n, wn, r, e, u) : Ir(t, n, f, wn, r, e, u);
                    ...
                    if (c) n: if (u || (u = new Nt), o = 2 & e, f = He(t), i = f.length, c = He(n).length, i == c || o) {
                        for (a = i; a--;) {
                            var l = f[a];
                            if (!(o ? l in n : yn(n, l))) {
                                n = !1;
                        ...
                        if (c = u.get(t)) n = c == n;
                            ...
                            c && !s && (r = t.constructor, e = n.constructor, r != e && "constructor" in t && "constructor" in n && !("function" == typeof r && r instanceof r && "function" == typeof e && e instanceof e) && (c = !1)), u["delete"](t), n = c
                        }
                    } else n = !1;
                    else n = !1
                }
        ...
        function An(t, n, r, e) {
            ...
            for (; ++u < o;) {
                var f = r[u],
                    ...
                    l = f[1];
                if (i && f[2]) {
                    if (a === q && !(c in t)) return !1
                } else {
                    if (f = new Nt, e) var s = e(a, l, c, t, n, f);
                    if (s === q ? !wn(l, a, e, 3, f) : !s) return !1
                }
            }
            return !0
        }
        ...
        function On(t) {
            return "function" == typeof t ? t : null == t ? iu : "object" == typeof t ? oi(t) ? Sn(t[0], t[1]) : In(t) : lu(t)
        }
                    ...
                    if (i && (f = u, u = n[f]), Be(u)) {
                        ...
                        if (h) Qt(t, c, h);
                            ...
                            var h = e ? e(l, s, c + "", t, n, a) : q,
                                p = h === q;
                            p && (h = s, oi(s) || Fe(s) ? oi(l) ? h = l : Ee(l) ? h = or(l) : (p = !1, h = un(s, !0)) : ze(s) || Oe(s) ? Oe(l) ? h = Ve(l) : !Be(l) || r && Se(l) ? (p = !1, h = un(s, !0)) : h = l : p = !1), a.set(s, h), p && Rn(h, s, r, e, a), a["delete"](s), Qt(t, c, h)
                        }
        ...
        function dr(t) {
            return je(function(n) {
                ...
                for (t && n.reverse(); e--;) {
                    var o = n[e];
                    if ("function" != typeof o) throw new vu("Expected a function");
                    if (u && !i && "wrapper" == Sr(o)) var i = new kt([], (!0))
                }
        ...
        function wr(t) {
            return function(n, r, e) {
                e && "number" != typeof e && Zr(n, r, e) && (r = e = q), n = qe(n), n = n === n ? n : 0, r === q ? (r = n, n = 0) : r = qe(r) || 0, e = e === q ? r > n ? 1 : -1 : qe(e) || 0;
                var u = -1;
                r = Tu(Du((r - n) / (e || 1)), 0);
        ...
        function kr(t, n, r, e, u, o, i, f) {
            var c = 2 & n;
            if (!c && "function" != typeof t) throw new vu("Expected a function");
            var a = e ? e.length : 0;
        ...
        function Dr(t) {
            return "function" != typeof t.constructor || Kr(t) ? {} : fn(Fu(Object(t)))
        }
        ...
        function $r(r, e, u, o) {
            ...
            switch (e) {
                ...
                case "[object Map]":
                    return e = o ? u($(r), !0) : $(r), s(e, t, new r.constructor);
                case "[object Number]":
                case "[object String]":
                    return new i(r);
                case "[object RegExp]":
                ...
                case "[object Set]":
                    return e = o ? u(N(r), !0) : N(r), s(e, n, new r.constructor);
                case "[object Symbol]":
        ...
        function Zr(t, n, r) {
            if (!Be(r)) return !1;
            var e = typeof n;
            return !!("number" == e ? ke(r) && U(n, r.length) : "string" == e && n in r) && we(r[n], t)
        }

        function Tr(t, n) {
            var r = typeof t;
            return "number" == r || "symbol" == r || !oi(t) && ($e(t) || ot.test(t) || !ut.test(t) || null != n && t in Object(n))
        }
        ...
        function Vr(t) {
            var n = Sr(t),
                r = jt[n];
            return "function" == typeof r && n in Et.prototype && (t === r || (n = jo(r), !!n && t === n[0]))
        }

        function Kr(t) {
            var n = t && t.constructor;
            return t === ("function" == typeof n && n.prototype || du)
        }

        function Gr(t, n) {
            return function(r) {
                return null != r && (r[t] === n && (n !== q || t in Object(r)))
            }
        }
        ...
        function Hr(t) {
            return "string" == typeof t || $e(t) ? t : t + ""
        }
        ...
        function ie(t) {
            ...
            return t = i(t, function(t) {
                return Ee(t) ? (n = Tu(t.length, n), !0) : void 0
            }), w(n, function(n) {
                return a(t, Mn(n))
            })
        }
        ...
        function se(t, n) {
            return "function" == typeof n && oi(t) ? u(t, n) : _o(t, Rr(n))
        }

        function he(t, n) {
            var r;
            if ("function" == typeof n && oi(t)) {
                for (r = t.length; r-- && !1 !== n(t[r], r, t););
                r = t
            } else r = vo(t, Rr(n));
            return r
        }
        ...
        function _e(t, n, r) {
            var e = -1,
                ...
                o = u.length,
                i = o - 1;
            for (n = (r ? Zr(t, n, r) : n === q) ? 1 : en(Ze(n), 0, o); ++e < n;) t = $n(e, i), r = u[t], u[t] = u[e], u[e] = r;
            return u.length = n, u
        }
        ...
        function ge(t, n) {
            var r;
            if ("function" != typeof n) throw new vu("Expected a function");
            return t = Ze(t),
                function() {
        ...
        function xe(t, n) {
            ...
            if ("function" != typeof t || n && "function" != typeof n) throw new vu("Expected a function");
        ...
        function Ie(t) {
            return !!Le(t) && ("[object Error]" == wu.call(t) || "string" == typeof t.message && "string" == typeof t.name)
        }
        ...
        function Ce(t) {
            return !!Be(t) && (Se(t) || z(t) ? Ou : bt).test(Qr(t))
        }

        function Me(t) {
            return "number" == typeof t || Le(t) && "[object Number]" == wu.call(t)
        }

        function ze(t) {
            return !(!Le(t) || "[object Object]" != wu.call(t) || z(t)) && (t = Fu(Object(t)), null === t || (t = xu.call(t, "constructor") && t.constructor, "function" == typeof t && t instanceof t && bu.call(t) == mu))
        }
        ...
        function De(t) {
            return "string" == typeof t || !oi(t) && Le(t) && "[object String]" == wu.call(t)
        }

        function $e(t) {
            return "symbol" == typeof t || Le(t) && "[object Symbol]" == wu.call(t)
        }
        ...
        function qe(t) {
            ...
            if ($e(t)) return K;
            if (Be(t) && (t = Se(t.valueOf) ? t.valueOf() : t, t = Be(t) ? t + "" : t), "string" != typeof t) return 0 === t ? t : +t;
            t = t.replace(at, "");
            var n = yt.test(t);
        ...
        function fu(t) {
            return On("function" == typeof t ? t : un(t, !0))
        }
        ...
        var su = S.Date,
            ...
            Lu = "symbol" == typeof(Lu = Iu && Iu.iterator) ? Lu : q,
            Cu = Object.create,
        ...
        jt.templateSettings = {
            ...
            var n = this.__data__;
            return qr(t) ? (n = "string" == typeof t ? n.string : n.hash, t = (ro ? n[t] !== q : xu.call(n, t)) && delete n[t]) : t = Qu ? n.map["delete"](t) : Tt(n.map, t), t
        }, Dt.prototype.get = function(t) {
            var n = this.__data__;
            return qr(t) ? (n = "string" == typeof t ? n.string : n.hash, ro ? (t = n[t], t = "__lodash_hash_undefined__" === t ? q : t) : t = xu.call(n, t) ? n[t] : q) : t = Qu ? n.map.get(t) : qt(n.map, t), t
        }, Dt.prototype.has = function(t) {
            var n = this.__data__;
            return qr(t) ? (n = "string" == typeof t ? n.string : n.hash, t = ro ? n[t] !== q : xu.call(n, t)) : t = Qu ? n.map.has(t) : -1 < Kt(n.map, t), t
        }, Dt.prototype.set = function(t, n) {
            var r = this.__data__;
            return qr(t) ? ("string" == typeof t ? r.string : r.hash)[t] = ro && n === q ? "__lodash_hash_undefined__" : n : Qu ? r.map.set(t, n) : Gt(r.map, t, n), this
        }, $t.prototype.push = function(t) {
            var n = this.__data__;
            qr(t) ? (n = n.__data__, ("string" == typeof t ? n.string : n.hash)[t] = "__lodash_hash_undefined__") : n.set(t, "__lodash_hash_undefined__")
        ...
        var Ao = function() {
            ...
            ko = je(function(t, n) {
                return Ee(t) ? an(t, hn(n, 1, Ee, !0)) : []
            }),
            Eo = je(function(t, n) {
                var r = ee(n);
                return Ee(r) && (r = q), Ee(t) ? an(t, hn(n, 1, Ee, !0), Rr(r)) : []
            }),
            Io = je(function(t, n) {
                var r = ee(n);
                return Ee(r) && (r = q), Ee(t) ? an(t, hn(n, 1, Ee, !0), q, r) : []
            }),
            So = je(function(t) {
                var n = a(t, Qn);
            ...
            Co = je(function(t) {
                return Kn(hn(t, 1, Ee, !0))
            }),
            Mo = je(function(t) {
                var n = ee(t);
                return Ee(n) && (n = q), Kn(hn(t, 1, Ee, !0), Rr(n))
            }),
            zo = je(function(t) {
                var n = ee(t);
                return Ee(n) && (n = q), Kn(hn(t, 1, Ee, !0), q, n)
            }),
            Uo = je(function(t, n) {
                return Ee(t) ? an(t, n) : []
            }),
        ...
        return jt.after = function(t, n) {
            ...
            return t && t.length ? Gn(t, Rr(n, 3), !0, !0) : []
        }, jt.dropWhile = function(t, n) {
            return t && t.length ? Gn(t, Rr(n, 3), !0) : []
        }, jt.fill = function(t, n, r, e) {
            var u = t ? t.length : 0;
            if (!u) return [];
            for (r && "number" != typeof r && Zr(t, n, r) && (r = 0, e = u), u = t.length, r = Ze(r), 0 > r && (r = -r > u ? 0 : u + r), e = e === q || e > u ? u : Ze(e), 0 > e && (e += u), e = r > e ? 0 : Te(e); e > r;) t[r++] = n;
            return t
            ...
            return e = "function" == typeof e ? e : q, null == t ? t : Nn(t, n, r, e)
        }, jt.shuffle = function(t) {
            return _e(t, 4294967295)
        }, jt.slice = function(t, n, r) {
            var e = t ? t.length : 0;
            return e ? (r && "number" != typeof r && Zr(t, n, r) ? (n = 0, r = e) : (n = null == n ? 0 : Ze(n), r = r === q ? e : Ze(r)), Pn(t, n, r)) : []
            ...
            return r && "number" != typeof r && Zr(t, n, r) && (n = r = q), r = r === q ? 4294967295 : r >>> 0, r ? (t = Ke(t)) && ("string" == typeof n || null != n && !Ue(n)) && (n += "", "" == n && Bt.test(t)) ? tr(t.match(Rt), 0, r) : Yu.call(t, n, r) : []
            ...
            return t && t.length ? Gn(t, Rr(n, 3), !1, !0) : []
            ...
            if (null == t) r = !0;
                ...
                var e = n,
                    e = Tr(e, r) ? [e] : Xn(e);
                r = Yr(r, e), e = ee(e), r = null == r || !Je(r, e) || delete r[e]
            }
            return r
        }, jt.unzip = ie, jt.unzipWith = fe, jt.update = function(t, n, r) {
            return null == t ? t : Nn(t, n, ("function" == typeof r ? r : iu)(gn(t, n)), void 0)
        }, jt.updateWith = function(t, n, r, e) {
            return e = "function" == typeof e ? e : q, null != t && (t = Nn(t, n, ("function" == typeof r ? r : iu)(gn(t, n)), e)), t
            ...
            return t && t.length ? g(t, Rr(n, 3), !0) : -1
        }, jt.findLastKey = function(t, n) {
            return v(t, Rr(n, 3), _n, !0)
            ...
            return !0 === t || !1 === t || Le(t) && "[object Boolean]" == wu.call(t)
            ...
            return r = "function" == typeof r ? r : q, An(t, n, Wr(n), r)
        }, jt.isNaN = function(t) {
            return Me(t) && t != +t
            ...
            if (!e) return -1;
            var u = e;
            if (r !== q && (u = Ze(r), u = (0 > u ? Tu(e + u, 0) : qu(u, e - 1)) + 1), n !== n) return M(t, u, !0);
            for (; u--;)
                if (t[u] === n) return u;
            return -1
            ...
            if (r && "boolean" != typeof r && Zr(t, n, r) && (n = r = q), r === q && ("boolean" == typeof n ? (r = n, n = q) : "boolean" == typeof t && (r = t, t = q)), t === q && n === q ? (t = 0, n = 1) : (t = qe(t) || 0, n === q ? (n = t, t = 0) : n = qe(n) || 0), t > n) {
                var e = t;
                t = n, n = e
            }
            ...
            if (t.replace(r, function(n, r, e, i, f, l) {
                    return e || (e = i), a += t.slice(c, l).replace(At, C), r && (u = !0, a += "'+__e(" + r + ")+'"), f && (o = !0, a += "';" + f + ";\n__p+='"), e && (a += "'+((__t=(" + e + "))==null?'':__t)+'"), c = l + n.length, n
            ...
            return "function" == typeof t ? new Et(this) : this.map(function(r) {
                return mn(r, t, n)
            })
    ...
    zt["[object Arguments]"] = zt["[object Array]"] = zt["[object ArrayBuffer]"] = zt["[object DataView]"] = zt["[object Boolean]"] = zt["[object Date]"] = zt["[object Float32Array]"] = zt["[object Float64Array]"] = zt["[object Int8Array]"] = zt["[object Int16Array]"] = zt["[object Int32Array]"] = zt["[object Map]"] = zt["[object Number]"] = zt["[object Object]"] = zt["[object RegExp]"] = zt["[object Set]"] = zt["[object String]"] = zt["[object Symbol]"] = zt["[object Uint8Array]"] = zt["[object Uint8ClampedArray]"] = zt["[object Uint16Array]"] = zt["[object Uint32Array]"] = !0,
        zt["[object Error]"] = zt["[object Function]"] = zt["[object WeakMap]"] = !1;
    var Ut = {
            "À": "A",
            "Á": "A",
            "Â": "A",
        ...
        Yt = S(Tt && qt && "object" == typeof global && global) || Gt !== (Jt && Jt.window) && Gt || Kt || Jt || Function("return this")(),
        Ht = T();
    (Gt || Kt || {})._ = Ht, "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
        return Ht
    }) : Tt && qt ? (Vt && ((qt.exports = Ht)._ = Ht), Tt._ = Ht) : Yt._ = Ht
}).call(this);
/* main.js */
function imageSlide(e, t) {
    function n() {
        l || (l = setTimeout(function() {
            l = null, r.style.position = "relative", r.style.left = (window.innerWidth - m[0].clientWidth) / 2 + "px", c(0), f = Flipsnap(r, {
                distance: m[0].clientWidth,
                maxPoint: v,
                duration: u
            }), f.moveToPoint(s, 0), f.element.addEventListener("fspointmove", i), Array.prototype.slice.call(d).forEach(function(e, t) {
                e.addEventListener("click", function(e) {
                    console.log(t + s), f.moveToPoint(t + s)
                }, !1)
            })
        }, 66))
    }
    ...
    function i(e) {
        f.currentPoint > f.maxPoint - 1 ? o(!0) : f.currentPoint < s ? o() : c(f.currentPoint - s)
    }

    function o(e) {
        var t, n;
        e ? (t = f.maxPoint, n = s) : (t = 1, n = f.maxPoint - 1), f.element.removeEventListener("fspointmove", i), f.moveToPoint(t), timer = setTimeout(function() {
            f.moveToPoint(n, 0), c(n - s), f.element.addEventListener("fspointmove", i), clearTimeout(timer)
        }, u + 3)
    }
    ...
    function a(e, t) {
        var n = document.createDocumentFragment(),
            i = e.length;
        return _.range(i + 2 * t).forEach(function(t, o) {
            var a = (o % i + 1) % i;
            n.appendChild(e[a].cloneNode(!0))
        }), n
    }

    function c(e) {
        Array.prototype.slice.call(d).forEach(function(t, n) {
            n !== e || t.className.match("isActive") ? n !== e && t.className.match("isActive") && (t.className = t.className.replace(" isActive", "")) : t.className += " isActive"
        })
    }
    var l = null,
        s = t.extra || 2,
        r = document.getElementById(e),
        m = document.getElementsByClassName(t.itemClassName || "js-slide-item"),
        d = document.getElementsByClassName(t.pointClassName || "js-slide-point"),
        u = t.duration || 350,
        v = m.length + s,
        f = null;
    if (r && m && d) {
        if (m.length < 2) return m[0].style.margin = "0 auto", void Array.prototype.slice.call(d).map(function(e, t) {
            e.style.display = "none"
        });
        var p = a(m, s);
        r.innerHTML = "", r.appendChild(p), n(), window.addEventListener("resize", n, !1)
    }
}! function() {
    function e(e, t, n) {
        var i = " " + t;
        return function(n) {
            e.className.indexOf(t) > -1 ? e.className = e.className.replace(i, "") : e.className += i
        }
    }
    var t = document.getElementById("menu-button"),
        ...
        o = e(n, "isOpened");
    t && i && (t.addEventListener("click", o, !1), i.addEventListener("click", o, !1))
}();